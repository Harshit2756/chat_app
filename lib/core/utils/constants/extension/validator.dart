...
extension StringValidation on String? {
  ...
  /// Check if string is valid date in format dd/MM/yyyy
  bool get isDate => this != null && RegExp(r'^(0[1-9]|[12][0-9]|3[01])\/(0[1-9]|1[0-2])\/\d{4}$').hasMatch(this!);
  ...
  /// Validates that the string is a valid date in format dd/MM/yyyy
  String? validateDate() {
    if (isEmptyOrNull) {
    ...
    try {
      if (this != null) {
        ...
        if (date.isBefore(DateTime(1950))) {
          return 'Date cannot be before 1950';
        }
      }
    } catch (e) {
